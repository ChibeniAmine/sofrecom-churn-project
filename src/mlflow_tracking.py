    ...
    try:
        ...
        if experiment is None:
            ...
            experiment_id = mlflow.create_experiment(
                ...
                artifact_location=str(project_root / "models")  # Optionnel: où sauvegarder les modèles
            )
            logger.info(f"✅ Nouvelle expérience créée: {experiment_name} (ID: {experiment_id})")
        else:
